...
.factory('populars', ['$http', '$q', 'COOLSTORE_CONFIG', 'Auth', '$location', function($http, $q, COOLSTORE_CONFIG, $auth, $location) {
	var factory = {}, products, baseUrl;

    if(!!COOLSTORE_CONFIG.MONOLITH) {
		baseUrl='/services/populars';
	} else {
	...
	factory.getPopularProducts = function() {
